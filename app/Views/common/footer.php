        ...
        <div class="footer">
            <div class="row">
                ...
                <div class="col-6 col-md-6 col-lg-2 p-0">
                    ...
                    <div><a href="#"><i class="fab fa-facebook-square mr-3"></i></a></div>
                    <div><a href="#"> <i class="fab fa-twitter mr-3"></i></a></div>
                    <div><a href="#"> <i class="fab fa-google mr-3"></i></a></div>
                    <div><a href="#"> <i class="fab fa-linkedin mr-3"></i></a></div>
                    <div><a href="#"> <i class="fab fa-instagram mr-3"></i></a></div>
                </div>


                <div class="col-6 col-md-6 col-lg-4 p-0">
                    <div class="footerHeading">Contact us</u></div>
                    ...
                    <div class="input-group mt-3">
                        <input type="text" class="form-control" placeholder="free news letter subscription">
...
<!--====== FOOTER PART ENDS ======-->
<div id="drawer" class="col-sm-none">
